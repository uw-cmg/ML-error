...
# Path to save files
path = 'Supplemental_Info/{}/5-Fold/RF'.format(dataset)
#path = 'plots/'
...
CVD = cvd.CVData()
CV_residuals, CV_model_errors = CVD.get_residuals_and_model_errors("RF", X_train_split, y_train_split)
...
MP = mp.MakePlot()
#unscaled
MP.make_rve(CV_residuals, CV_model_errors, "RF, {}, Unscaled".format(dataset), save=True,
            file_name=path + '/CV_Plots/unscaled_RvE.png')
MP.make_rve_bin_counts(CV_model_errors, "RF, {}, Unscaled".format(dataset), save=True,
            file_name=path + '/CV_Plots/unscaled_RvE_bin_counts.png')
MP.make_rstat(CV_residuals, CV_model_errors, "RF, {}, Unscaled".format(dataset), save=True,
            file_name=path + '/CV_Plots/unscaled_rstat.png')
#scaled
MP.make_rve(CV_residuals, CV_model_errors*a + b, "RF, {}, Scaled".format(dataset), save=True,
            file_name=path + '/CV_Plots/scaled_RvE.png')
MP.make_rve_bin_counts(CV_model_errors*a + b, "RF, {}, Scaled".format(dataset), save=True,
            file_name=path + '/CV_Plots/scaled_RvE_bin_counts.png')
MP.make_rstat(CV_residuals, CV_model_errors*a + b, "RF, {}, Scaled".format(dataset), save=True,
            file_name=path + '/CV_Plots/scaled_rstat.png')


# Get test data residuals and model errors
TD = td.TestData()
Test_residuals, Test_model_errors_unscaled, Test_model_errors_scaled = TD.get_residuals_and_model_errors_looped("RF", X_train, y_train)

# Make scaled and unscaled test data plots
MP.make_rve(Test_residuals, Test_model_errors_unscaled, "RF, {}, Unscaled, Test Set".format(dataset), save=True,
            file_name=path + '/Test_Plots/unscaled_RvE.png')
MP.make_rve_bin_counts(Test_model_errors_unscaled, "RF, {}, Unscaled, Test Set".format(dataset), save=True,
            file_name=path + '/Test_Plots/unscaled_RvE_bin_counts.png')
MP.make_rstat(Test_residuals, Test_model_errors_unscaled, "RF, {}, Unscaled, Test Set".format(dataset), save=True,
            file_name=path + '/Test_Plots/unscaled_rstat.png')
#scaled
MP.make_rve(Test_residuals, Test_model_errors_scaled, "RF, {}, Scaled, Test Set".format(dataset), save=True,
            file_name=path + '/Test_Plots/scaled_RvE.png')
MP.make_rve_bin_counts(Test_model_errors_scaled, "RF, {}, Scaled, Test Set".format(dataset), save=True,
            file_name=path + '/Test_Plots/scaled_RvE_bin_counts.png')
MP.make_rstat(Test_residuals, Test_model_errors_scaled, "RF, {}, Scaled, Test Set".format(dataset), save=True,
