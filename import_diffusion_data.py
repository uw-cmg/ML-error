...
# import data
data = io.importdata('diffusion_data/Diffusion_Data_allfeatures.csv')
...
np.save('diffusion_data/all_x_values.npy', X_values)
np.save('diffusion_data/all_y_values.npy', y_values)